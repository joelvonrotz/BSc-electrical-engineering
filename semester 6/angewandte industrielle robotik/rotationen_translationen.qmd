...
&=\begin{bmatrix}
C_A \cdot C_{\theta} & -S_A \cdot C_C + C_A \cdot S_{\theta} \cdot S_C &  S_A \cdot S_C + C_A \cdot S_{\theta} \cdot C_C \\
S_A \cdot C_{\theta} &  C_A \cdot C_C + S_A \cdot S_{\theta} \cdot S_C & -C_A \cdot S_C + S_A \cdot S_{\theta} \cdot C_C \\
-S_{\theta}      &  C_{\theta} \cdot S_C    &  C_{\theta} \cdot C_C
\end{bmatrix}
\end{split}
$$
...
Während bei [Euler Drehungen]{.underline} immer [vom neuen Koordinatensystem gedreht]{.underline} wird, werden bei [RPY Drehungen]{.underline} immer vom [Ursprünglichen Koordinatensystem gedreht]{.underline}
