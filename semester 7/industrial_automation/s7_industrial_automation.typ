...
#table(columns: 5, inset: (x:3pt),
  table.header(
    [*Type*],[*Lower*],[*Upper*],[*Bits*],[*Note*],
  ),
  [`BOOL`],[$0$],[$1$],[$8$],[#small[>1 are invalid values]],
  [`BYTE`],[$0$],[$255$],[$8$],[],
  [`WORD`],[$0$],[$65535$],[$16$],[],
...
#table(columns: 4, inset: (x:3pt),
align: (center, left, center, left),
table.header(
  table.cell(colspan: 2, fill: color.lighten(gray, 60%))[*Englisch*],table.cell(colspan: 2, fill: color.lighten(gray, 60%))[*Deutsch*],
),
