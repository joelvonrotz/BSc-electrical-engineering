...
[**M1**: **M**ittelpunktschaltung **1**]{.underline}
...
[**B2**: **B**rückenschaltung **2** Dioden]{.underline}
...
[Mit Dioden]{.underline}

![](images/paste-9.png)

$$
\begin{split}
U_{di0}&=\frac{1}{T}\int_{0}^{T}{u_d}\space dt=\frac{1}{\pi}\int_{0}^{\pi}{u_d}\space d\omega \\
  &=\frac{2}{\pi}\hat{U}=\frac{2\sqrt2}{\pi}U_N\approx0.9\cdot U_N
\end{split}
$$

[Mit Thyristoren]{.underline}

![](images/paste-10.png)

$$
U_{di\alpha}=\frac{1}{\pi}\int_{\alpha}^{\pi}{u_d}\space d\omega=U_{di0}\frac{1+cos(\alpha)}{2}
$$
...
$$
\begin{split}
U_{di\alpha}&=\frac{1}{\pi}\int_\alpha^{\pi+\alpha}{u_d}\space d\omega \\
...
U_{di\alpha}=                                       
\begin{cases}                                       
\sqrt{2}\cdot U_N & 0\degree<\alpha <90\degree \\
\sqrt{2}\cdot U_N\cdot\sin(\alpha) & 90\degree<\alpha <180\degree
\end{cases}
$$
