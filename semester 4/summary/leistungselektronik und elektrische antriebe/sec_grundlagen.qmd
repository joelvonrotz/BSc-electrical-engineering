...
![](images/01_LorentzKraft.png){width="4cm"}
...
![](images/01_Eisenkern.png){width="6cm"}
...
Die übrigen Frequenzanteile des Stromes verursachen Verluste in den Leitungen ($\rightarrow$ Blindleistung). Dies wird *Verzerrungsblindleistung* $D$ genannt.
$$
