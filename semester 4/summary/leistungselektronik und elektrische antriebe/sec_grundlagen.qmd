...
$$
\begin{split}
S^2 =& P^2+Q^2\\=&P_1^2+\underbrace{P_2^2}_{P\space\text{Oberschwingungen}\atop U_2\cdot I_2} +\underbrace{Q_1^2}_{Q\space\text{aus Oberschwingungen}\atop U_2=0,\space U_1\cdot I_2}+Q_D^2\\=&S_1^2+Q_D^2
\end{split}
$$
