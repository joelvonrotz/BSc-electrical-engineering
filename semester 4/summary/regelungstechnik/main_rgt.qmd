...
![](images/closed_loop.png){width="8cm"}

![](images/open-loop.png){width="8cm"}
...
## Steuerung (Feed[forward]{.underline} Control)

![](images/steuerung.png){width="8cm"}

## Regelung (Feed[back]{.underline} Control)

![](images/regelung.png){width="8cm"}
...
![](images/definition_regelung.png){width="8cm"}
