...
\hypersetup{
  pdftitle={Zusammenfassung Digital Design},
...
\title{Zusammenfassung Digital Design}
...
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[colback={shadecolor}, boxrule=0pt, frame hidden, enhanced, breakable]}{\end{tcolorbox}}\fi\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[colback={shadecolor}, boxrule=0pt, frame hidden, breakable, enhanced]}{\end{tcolorbox}}\fi
...
\hypertarget{hallo-dide}{%
\section{Hallo Dide}\label{hallo-dide}}
