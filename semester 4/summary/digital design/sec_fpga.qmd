...
Das FPGA-Board hat zwei Begrenzungen: [totaler Speicher]{.underline} ist [36KBit]{.underline} und [Maximale Anzahl Blöcke]{.underline} sind [60 Blöcke]{.underline}.
...
$\textcolor{BrickRed}{\mathbf{1}}$: immer da, irgendeine Info
