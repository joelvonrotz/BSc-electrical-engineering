...
Beim *Mealy* werden die Ausgänge [beim Zustandswechsel]{.underline} geändert. Es handelt sich also um einen *0-delay-enable-type*
...
Beim *Moore* werden die Ausgänge [im Zustand]{.underline} geändert. Es handelt sich also um einen *1-delay-state-type*
