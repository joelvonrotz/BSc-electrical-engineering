...
MP3/MPEG De-/Encodierung, Verschlüsselung, Noise Canceling.

2.  Nenne drei gute Beispiele eines reaktiven Systems.

ABS, Roll-Over-Detection, Regelkreis eines positiongesteuerten Motors
...
8.  Viele Systeme sind eine Kombination von transformierenden, reaktiven und interaktiven Systemen. Bestimme diese am Beipsiel eines Smartphones
...
Das genügend Informationen in die Encodierung einberechnet werden, bzw. dass man die Audio-Qualität nicht verliert.
...
*Interaktiv*: Geldautomat, Tankanzeige im Flugzeug

*Reaktiv*: Airbag, Polizei-Radar, Feuer Alarmsystem

*Transformativ*: Tankanzeige im Flugzeug
