...
$$
P[a\vert b]=Q\left(\frac{b-V_{ref}}{\sigma_0^2}\right)=Q(k)
$$
...
$$
P[a\vert b]=Q\left(\frac{a-V_{ref}}{\sigma_0}\right)=Q(k)
$$
...
$$
d_{min}=\frac{D_{min}}{\sqrt{2\cdot E_b}} \qquad P_b = Q\left(\sqrt{d_{min}^2\cdot\frac{E_b}{N_0}}\right)
$$
