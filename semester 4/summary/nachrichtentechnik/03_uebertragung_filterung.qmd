...
### Streuparameter bei Zweitore (evtl. nicht so wichtig!)

![](images/1280px-S-Parameter.png){width="8cm"}

`\begin{multicols}{2}`{=latex}

#### Eingangsreflexionsfaktor $s_11$
...
#### Vorwärts-Transmissionsfaktor $s_21$
...
#### Rückwärts-Transmissionsfaktor $s_12$
