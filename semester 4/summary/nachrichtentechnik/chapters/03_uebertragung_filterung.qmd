...
Die Richtwirkung $D$ beträgt beim *isotropen Strahler* $1$. Bei einer *dipol-Antenne* gilt $D=1.64$. Allgemein wird die Richtwirkung über die maximale Leistungsdichte $S(\theta,\varphi)_{max}$ einer gerichteten Antenne bestimmt (wobei $\Delta\theta°_{-3dB}$ und $\Delta\varphi°_{-3dB}$ den Öffnungswinkel in der Horizontalen- bzw. Vertikalen-Ebene beschreiben)

$$
D=\frac{S(\theta,\varphi)_{max}}{S_{iso}}\approx\frac{32400}{\Delta\theta°_{-3dB}\space\Delta\varphi°_{-3dB}}
$$
...
L_M[dB]=32.4+20\log_{10}{(f[GHz])}+10\gamma\log_{10}{(r[m])}
$$
