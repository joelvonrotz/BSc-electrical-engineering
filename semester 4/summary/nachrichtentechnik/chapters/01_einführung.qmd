...
$$
T_a=\frac{Entfernung\space [m]}{Ausbreitungsgeschwindigkeit\space[\frac{m}{s}]}\qquad[s]
$$

Übertragungsverzögerung *transmission delay*

$$
T_{\ddot{u}}=\frac{Paketgrösse\space[byte]}{Datenrate\space[\frac{bytes}{s}]}\qquad[s]
$$
