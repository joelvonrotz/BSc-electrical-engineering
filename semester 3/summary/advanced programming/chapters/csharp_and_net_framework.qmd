...
Methoden sind das C#-pendant der Funktionen in C. Der Zugriff auf Methoden kann mit Zugriff-Modifizierern *(siehe @sec-modifier)* eingeschränkt werden. Methoden werden über Objekte aufgerufen.
...
*Getter*- und *Setter*-Methoden sind sehr umständlich und führen bei vielen Variablen zu viel Code. Aus diesem Grund werden automatische Getter- und Setter-Methoden genutzt, nämlich **Properties** mit den Schlüsselwörtern `get` und `set`.
