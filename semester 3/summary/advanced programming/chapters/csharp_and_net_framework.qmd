...
Die Grösse des Arrays wird bei der Initialisierung festgelegt. Diese Grösse kann **nicht** verändert werden.
:::

Ein **eindimensionales** Array ist das standardmässige Array und 
...
Ein **Multi-dimensionales** oder **rechteckiges** Array 
