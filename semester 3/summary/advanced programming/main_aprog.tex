...
\begin{tcolorbox}[enhanced jigsaw, breakable, colbacktitle=quarto-callout-tip-color!10!white, bottomtitle=1mm, toptitle=1mm, opacitybacktitle=0.6, colback=white, rightrule=.15mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Tipp}, toprule=.15mm, coltitle=black, colframe=quarto-callout-tip-color-frame, titlerule=0mm, arc=.35mm, bottomrule=.15mm, leftrule=.75mm, left=2mm, opacityback=0]
...
eigenen Dateien erstellt werden.

Um Enums in logischen Operation oder als Flags zu nutzen kann dies mit
dem Attribut \VERB|\OperatorTok{[}\NormalTok{Flags}\OperatorTok{]}|
angegeben werden.
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{if}\OperatorTok{(}\NormalTok{c }\OperatorTok{==}\NormalTok{ Colors}\OperatorTok{.}\FunctionTok{Yellow}\OperatorTok{)} \OperatorTok{...}                    \CommentTok{// Vergleich}
...
\NormalTok{c }\OperatorTok{=}\NormalTok{ c }\OperatorTok{+} \DecValTok{1}\OperatorTok{;}                                    \CommentTok{// +, {-}}
\NormalTok{c}\OperatorTok{++;}                                          \CommentTok{// ++, {-}{-}}
\NormalTok{btn}\OperatorTok{.}\FunctionTok{UP} \OperatorTok{\&}\NormalTok{ btn}\OperatorTok{.}\FunctionTok{DOWN}  \CommentTok{// = "12" {-}\textgreater{} UP, DOWN      // \&, |, \textasciitilde{}}
\end{Highlighting}
\end{Shaded}
